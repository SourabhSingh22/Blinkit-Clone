    ...
    return (
        <section className='bg-neutral-900 fixed top-0 left-0 bottom-0 right-0 bg-opacity-70 z-50'>
            <div className='bg-white w-full max-w-sm min-h-screen max-h-screen ml-auto'>
                    ...
                    <div className='bg-white rounded-lg p-4 grid gap-5 overflow-auto'>
                        {
                            cartItem[0] && (
                                cartItem.map((item, index)=>{
                                    return (
                                        <div className='flex w-full gap-4 border-b-2 items-center'>
                                            ...
                                            <div className='w-full max-w-sm'>
                                                <p className='text-xs 
                                               text-ellipsis line-clamp-2'>{item?.productId?.name}</p>
                ...
                <div className='p-2'>
                    <div className='bg-green-700 text-neutral-100 py-4 px-4 static botttom-3 font-bold text-base rounded flex items-center justify-between gap-3'>
                        <div>
