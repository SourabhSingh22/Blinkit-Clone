...
const EditProductAdmin = ({close, data : propsData, fetchProductData}) => {
    ...
    return (
        <section className='fixed top-0 left-0 bottom-0 right-0 w-full h-full bg-black flex items-center justify-center z-50 bg-opacity-70 p-4'>
                ...
                <section className=''>
                    ...
                    <div className='grid p-3'>
                        <form className='grid gap-4' onSubmit={handleSubmit}>
                                            ...
                                            data.image.map((img, index) => {
                                                return (
                                                    <div key={img + index} className='h-20 w-20 min-w-20 border relative group shadow-sm mt-1'>
                                                        ...
                                                        />
                                                        <div onClick={() => handleDeleteImage(index)} className='absolute bottom-0 right-0 p-1 bg-red-500 text-white hover:bg-red-600 rounded cursor-pointer hidden group-hover:block'>
                                                            <MdDelete />
                                                        </div>
                                                    </div>
                                                )
                            ...
                            <button className='border bg-yellow-400 hover:bg-yellow-500 py-2 rounded font-semibold'>Update Product</button>
